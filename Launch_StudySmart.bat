@echo off
REM Windows Batch script to launch StudySmart in Android Studio
setlocal

set "PROJECT_PATH=%~dp0Completed-Apps\advanced-apps\StudySmart"
set "STUDIO_PATH="
